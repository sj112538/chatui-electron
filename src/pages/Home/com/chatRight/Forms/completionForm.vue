<template>
  <div v-if="visible" class="chatForm">
    <simple-form v-model:formData="form.FormData['\'vits3\'']" :options="form.FormInfo!.chatCompletion.formOptions"
...
FormStore().setFormItem('completion')
