  ...
  <div :class="name">
    ...
    <el-dialog v-model="modelsVisible" title="添加模型" width="80%" align-center>
      <el-form inline :modelItem="modelsForm" ref="modelForm">
        ...
        <el-form-item label="预处理模型位置">
          <el-input v-model="modelsForm.clusterModelPath"></el-input>
          <file-manager :multiple="false" seleType='文件' v-model:路径="modelsForm.clusterModelPath" />
        </el-form-item>
      </el-form>
      <div class="footer">
...
},
{
  title: '预处理模型位置',
  width: 200,
  dataKey: 'clusterModelPath',
  key: "clusterModelPath"
},
{
  title: '模型位置',
  width: 200,
